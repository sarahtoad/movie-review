...
export default function AddMovieForm() {
  const [movie, setMovie] = useState<AddMovie>({
    title: "",
    genre: [], // ✅ Doit être un tableau vide au lieu de ""
    year: "",
    poster: "",
    synopsis: "",
    duration: "",
  ...
  // ✅ Modifié pour accepter soit string soit string[]
  ...
  async function submit() {
    ...
    // ✅ Envoie directement le tableau 'genre'
    const payload = {
      title: movie.title,
      ...
      runtime: movie.duration ? Number(movie.duration) : undefined,
  ...
  return (
    <div className="surface-panel w-full p-6 sm:p-8">
      ...
      >
        {loading ? "Publication en cours..." : "Publier le film"}
      </button>
    </div>
  );
}